function NBAGames() {
  ...
  const games = [
    {
      details: { league: "NBA" },
      schedule: { start: "2022-11-04T23:10:00.000Z" },
      teams: {
        away: teams.mia,
        home: teams.ind,
      },
    ...
    {
      details: { league: "NBA" },
      schedule: { start: "2022-11-04T23:40:00.000Z" },
      teams: {
        away: teams.chi,
        home: teams.bos,
      },
    ...
    {
      details: { league: "NBA" },
      schedule: { start: "2022-11-05T00:10:00.000Z" },
      teams: {
        away: teams.lac,
        home: teams.sas,
      },
    ...
    },
    {
      ...
      moneyline: { current: { awayOdds: "+440", homeOdds: "-590" } },
      total: {
    ...
    {
      details: { league: "NBA" },
      schedule: { start: "2022-11-05T00:40:00.000Z" },
      teams: {
        away: teams.gsw,
        home: teams.nop,
      },
    ...
    {
      details: { league: "NBA" },
      schedule: { start: "2022-11-05T02:10:00.000Z" },
      teams: {
        away: teams.por,
        home: teams.phx,
      },
      ...
      total: {
        current: { total: "219.0", overOdds: "-110", underOdds: "-110" },
      },
    },
    {
      details: { league: "NBA" },
    ...
    {
      details: { league: "NBA" },
      schedule: { start: "2022-11-05T02:40:00.000Z" },
      teams: {
        away: teams.uta,
        home: teams.lal,
      },
