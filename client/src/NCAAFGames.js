function NCAAFGames() {
  const teams = {
    bama: { team: "Alabama Crimson Tide", ranking: 1 },
    uga: { team: "Georgia Bulldogs", ranking: 2 },
    osu: { team: "Ohio State Buckeyes", ranking: 3 },
    mich: { team: "Michigan Wolverines", ranking: 4 },
    clemson: { team: "Clemson Tigers", ranking: 5 },
    usc: { team: "USC Trojans", ranking: 6 },
    okstate: { team: "Oklahoma State Cowboys", ranking: 7 },
    tenn: { team: "Tennessee Volunteers", ranking: 8 },
    miss: { team: "Ole Miss Rebels", ranking: 9 },
    psu: { team: "Penn State Nittany Lions", ranking: 10 },
    uu: { team: "Utah Utes", ranking: 11 },
    oregon: { team: "Oregon Ducks", ranking: 12 },
    uk: { team: "Kentucky Wildcats", ranking: 13 },
    ncst: { team: "NC State Wolfpack", ranking: 14 },
    wf: { team: "Wake Forest Demon Deacons", ranking: 15 },
    byu: { team: "BYU Cougars", ranking: 16 },
    tcu: { team: "TCU Horned Frogs", ranking: 17 },
    ucla: { team: "UCLA Bruins", ranking: 18 },
    ku: { team: "Kansas Jayhawks", ranking: 19 },
    ksu: { team: "Kansas State Wildcats", ranking: 20 },
    wash: { team: "Washington Huskies", ranking: 21 },
    cuse: { team: "Syracuse Orange", ranking: 22 },
    msu: { team: "Mississippi Bulldogs", ranking: 23 },
    cincy: { team: "Cincinnati Bearcats", ranking: 24 },
    lsu: { team: "LSU Tigers", ranking: 25 },
  };
  const games = [
    {
